...
async def on_ready():
    ...
    channel_id = int(os.getenv('CHANNEL_ID')) # Replace with your target channel ID
    image_path = "tvl_over_time.png"  # Replace with your desired image path
...
async def on_message(message):
    ...
    await bot.process_commands(message)  # This line is important to process commands when using on_message
